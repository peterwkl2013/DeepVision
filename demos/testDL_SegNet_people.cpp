...
#define TEST_SAMPLE_PATH "D:/testImages/JPEGImages_def2/"
...
/* 类别着色 */
...
#else
	/* open camera */
	//char *file = "D:/pmsWorks/X-VISION-AI_SDK/pic/leo_pc.avi";
	char *file = "./pic/leo_pc.avi";
	cap.open(file);
	...
	while (1)
	{
		...
		// set alg sub-type
		pAlg->sub_type = 5;   //road:0  object:1,5
