...
public:
    mv2DTemplateMatch()
    {
        ...
        num_detect = 1;
        config_path = "E:/X-VISION_SDK/demo_prj/AlgDemo/3rdparty/imvcfg/";
        overlap_thres = 0.7;
    }
...
int main(int argc, char * argv[])
{
    ...
    char *path1 = "E:/X-VISION_SDK/demo_prj/AlgDemo/3rdparty/pic/aoi/bd2_750x1024.bmp";
    char *path2 = "E:/X-VISION_SDK/demo_prj/AlgDemo/3rdparty/pic/aoi/bd2_750x1024.bmp";
